...
{
    // BLOCK IDS
    public static final int BLOCK_ID_ORES = 180;
    public static final int BLOCK_ID_RESOURCES = 181;
    public static final int BLOCK_ID_A = 182;
    public static final int BLOCK_ID_B = 183;
    public static final int BLOCK_ID_C = 184;
    public static final int BLOCK_ID_D = 185;
    public static final int BLOCK_ID_E = 186;
    public static final int BLOCK_ID_F = 187;
    public static final int BLOCK_ID_G = 188;
    public static final int BLOCK_ID_H = 189;
    
    // ITEM IDS
    public static final int ITEM_ID_MATERIALS = 500;
    ...
    public static final int TEXTURE_GRATE_BOTTOM_TOP = 49;
    public static final int TEXTURE_GRATE_SIDE = 48;
    public static final int TEXTURE_SPEAKER_BOTTOM_TOP = 50;
    public static final int TEXTURE_SPEAKER_SIDE = 51;
    public static final int TEXTURE_SMOKESTACK_BOTTOM = 56;
    public static final int TEXTURE_SMOKESTACK_TOP = 57;
    public static final int TEXTURE_SMOKESTACK_SIDE = 58;
    ...
    public static final String[] PAINT_BRUSH_NAMES =
    {
        "Black Paint Brush",
        "Red Paint Brush",
        "Green Paint Brush",
    ...
    public static final String[] DYE_ORE_DICTIONARY_NAMES =
    {
        "dyeBlack",
        "dyeRed",
        "dyeGreen",
    ...
    public static final Color[] MINECRAFT_COLORS =
    {
        COLOR_BLACK,
        COLOR_RED,
        COLOR_GREEN,
    ...
    public static final Map<String, Color> MC_COLORS = ImmutableMap.<String, Color>builder()
        ...
        .put(DYE_ORE_DICTIONARY_NAMES[15], COLOR_WHITE)
        .build();
