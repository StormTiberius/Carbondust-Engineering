...
public class WorldGenModule
{
    ...
    private static final int ORE_ENTRIES = 13;
    ...
    public static void preInit(FMLPreInitializationEvent event)
    {
        ...
        ARRAY[2] = cfg.get(Configuration.CATEGORY_GENERAL, "zinc", Defaults.ORE_GEN_DEFAULTS[2], DESCRIPTION).getIntList();
        ARRAY[3] = cfg.get(Configuration.CATEGORY_GENERAL, "silver", Defaults.ORE_GEN_DEFAULTS[3], DESCRIPTION).getIntList();
        ARRAY[4] = cfg.get(Configuration.CATEGORY_GENERAL, "lead", Defaults.ORE_GEN_DEFAULTS[4], DESCRIPTION).getIntList();
        ARRAY[5] = cfg.get(Configuration.CATEGORY_GENERAL, "uranium", Defaults.ORE_GEN_DEFAULTS[5], DESCRIPTION).getIntList();
        ARRAY[6] = cfg.get(Configuration.CATEGORY_GENERAL, "sulfur", Defaults.ORE_GEN_DEFAULTS[6], DESCRIPTION).getIntList();
        ARRAY[7] = cfg.get(Configuration.CATEGORY_GENERAL, "saltpeter", Defaults.ORE_GEN_DEFAULTS[7], DESCRIPTION).getIntList();
        ARRAY[8] = cfg.get(Configuration.CATEGORY_GENERAL, "quartz", Defaults.ORE_GEN_DEFAULTS[8], DESCRIPTION).getIntList();
        ...
        ARRAY[12] = cfg.get(Configuration.CATEGORY_GENERAL, "apatite", Defaults.ORE_GEN_DEFAULTS[12], DESCRIPTION).getIntList();
