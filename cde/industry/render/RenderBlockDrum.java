...
public class RenderBlockDrum implements ISimpleBlockRenderingHandler
{
    ...
    public static void drawInvBlock(Block block, ItemStack item)
    {
        ...
        for(int i = 0; i < 8; i++)
        {
            ...
            t.addVertexWithUV(dx(i + 1), 0.0D, dz(i + 1), DRUM_UV_IRON_TOP[0] + du2(i) * (double)wu, DRUM_UV_IRON_TOP[3]);
            t.addVertexWithUV(dx(i + 1), h2, dz(i + 1), DRUM_UV_IRON_TOP[0] + du2(i) * (double)wu, DRUM_UV_IRON_TOP[3] - ddv);
            t.addVertexWithUV(dx(i), h2, dz(i), DRUM_UV_IRON_TOP[0] + du(i) * (double)wu, DRUM_UV_IRON_TOP[3] - ddv);
            t.addVertexWithUV(dx(i), 0.0D, dz(i), DRUM_UV_IRON_TOP[0] + du(i) *(double)wu, DRUM_UV_IRON_TOP[3]);
            ...
            t.addVertexWithUV(dx(i + 1), 0.0D, dz(i + 1), DRUM_UV_IRON_TOP[0] + du2(i) * (double)wu, DRUM_UV_IRON_TOP[3]);
            t.addVertexWithUV(dx(i + 1), 0.05D, dz(i + 1), DRUM_UV_IRON_TOP[0] + du2(i) * (double)wu, DRUM_UV_IRON_TOP[3] - (double)wu * 0.05D);
            t.addVertexWithUV(dx(i), 0.05D, dz(i), DRUM_UV_IRON_TOP[0] + du(i) * (double)wu, DRUM_UV_IRON_TOP[3] - (double)wu *0.05D);
            t.addVertexWithUV(dx(i), 0.0D, dz(i), DRUM_UV_IRON_TOP[0] + du(i) * (double)wu, DRUM_UV_IRON_TOP[3]);
            ...
            w = (double)(base_w * h) * 0.9D;
            t.addVertexWithUV(1.0D - dx(i), 0.95D, 1.0D - dz(i), DRUM_UV_IRON_TOP[0] + du(i) * (double)wu, DRUM_UV_IRON_TOP[3]);
            t.addVertexWithUV(1.0D - dx(i), 1.0D, 1.0D - dz(i), DRUM_UV_IRON_TOP[0] + du(i) * (double)wu, DRUM_UV_IRON_TOP[3] - (double)wu * 0.05D);
            t.addVertexWithUV(1.0D - dx(i + 1), 1.0D, 1.0D - dz(i + 1), DRUM_UV_IRON_TOP[0] + du2(i) * (double)wu, DRUM_UV_IRON_TOP[3] - (double)wu * 0.05D);
            t.addVertexWithUV(1.0D - dx(i + 1), 0.95D, 1.0D - dz(i + 1), DRUM_UV_IRON_TOP[0] + du2(i) * (double)wu, DRUM_UV_IRON_TOP[3]);
        ...
        for(int i = 0; i < 8; i++)
        {
            ...
            w = base_w;
            t.addVertexWithUV(dx(i), 1.0D, dz(i), DRUM_UV_IRON_TOP[0] + dx(i) * (double)wu, DRUM_UV_IRON_TOP[3] - dz(i) * (double)wv);
            t.addVertexWithUV(dx(i + 1), 1.0D, dz(i + 1), DRUM_UV_IRON_TOP[0] + dx(i + 1) * (double)wu, DRUM_UV_IRON_TOP[3] - dz(i + 1) * (double)wv);
            ...
            w = (double)(base_w * h) * 0.9D;
            t.addVertexWithUV(dx(i), h, dz(i), DRUM_UV_IRON_TOP[0] + dx(i) * (double)wu, DRUM_UV_IRON_TOP[3] - dz(i) * (double)wv);
            t.addVertexWithUV(dx(i + 1), h, dz(i + 1), DRUM_UV_IRON_TOP[0] + dx(i + 1) * (double)wu, DRUM_UV_IRON_TOP[3] - dz(i + 1) * (double)wv);
        ...
        for(int i = 0; i < 8; i++)
        {
            ...
            w = (double)(base_w * h) * 0.9D;
            t.addVertexWithUV(dx(i), 0.0D, dz(i), DRUM_UV_IRON_TOP[0] + dx(i) * (double)wu, DRUM_UV_IRON_TOP[3] - dz(i) * (double)wv);
            t.addVertexWithUV(dx(i + 1), 0.0D, dz(i + 1), DRUM_UV_IRON_TOP[0] + dx(i + 1) * (double)wu, DRUM_UV_IRON_TOP[3] - dz(i + 1) * (double)wv);
            ...
            w = 0.0D;
            t.addVertexWithUV(dx(i), 1.0D - h, dz(i), DRUM_UV_IRON_TOP[0] + dx(i) * (double)wu, DRUM_UV_IRON_TOP[3] - dz(i) * (double)wv);
            t.addVertexWithUV(dx(i + 1), 1.0F - h, dz(i + 1), DRUM_UV_IRON_TOP[0] + dx(i + 1) * (double)wu, DRUM_UV_IRON_TOP[3] - dz(i + 1) * (double)wv);
            
            w = (double)(base_w * h) * 0.9D;
            t.addVertexWithUV(dx(i + 1), 1.0F - h, dz(i + 1), DRUM_UV_IRON_TOP[0] + dx(i + 1) * (double)wu, DRUM_UV_IRON_TOP[3] - dz(i + 1) * (double)wv);
            t.addVertexWithUV(dx(i), 1.0F - h, dz(i), DRUM_UV_IRON_TOP[0] + dx(i) * (double)wu, DRUM_UV_IRON_TOP[3] - dz(i) * (double)wv);
