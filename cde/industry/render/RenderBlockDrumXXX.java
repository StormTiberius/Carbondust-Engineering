...
public class RenderBlockDrumXXX implements ISimpleBlockRenderingHandler
{
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId, RenderBlocks renderer)
    {
        ...
        for(int i = 0; i < 8; i++)
        {
            ...
            t.addVertexWithUV((double)x + dx(i), (double)y + h2 * 2.0D, (double)z + dz(i), uvs[0] + du(i) * wu, uvs[2] + ddv);
            
            setB((double)(i + 1) - d, 1.0D);
            t.addVertexWithUV((double)x + dx(i + 1), (double)y + h2, (double)z + dz(i + 1), uvs[0] + du2(i) * wu, uvs[3] - ddv);
            t.addVertexWithUV((double)x + dx(i + 1), (double)y + h2 * 2.0D, (double)z + dz(i + 1), uvs[0] + du2(i) * wu, uvs[2] + ddv);
            
            setB((double)i + d, 1.0D);
            t.addVertexWithUV((double)x + dx(i), (double)y + h2 * 2.0D, (double)z + dz(i), uvs[0] + du(i) * wu, uvs[2] + ddv);
            t.addVertexWithUV((double)x + dx(i), (double)y + h2, (double)z + dz(i), uvs[0] + du(i) * wu, uvs[3] - ddv);
            ...
            setB((double)i + d, 0.6D);
            t.addVertexWithUV((double)(x + 1) - dx(i), (double)y + 0.95D, (double)(z + 1) - dz(i), uvs[0] + du(i) * wu, uvs[3]);
            t.addVertexWithUV((double)(x + 1) - dx(i), (double)y + 1.0D, (double)(z + 1) - dz(i), uvs[0] + du(i) * wu, uvs[3] - wu * 0.05D);
            
            setB((double)(i + 1) - d, 0.6D);
            t.addVertexWithUV((double)(x + 1) - dx(i + 1), (double)y + 1.0D, (double)(z + 1) - dz(i + 1), uvs[0] + du2(i) * wu, uvs[3] - wu * 0.05D);
            t.addVertexWithUV((double)(x + 1) - dx(i + 1), (double)y + 0.95D, (double)(z + 1) - dz(i + 1), uvs[0] + du2(i) * wu, uvs[3]);
            
            setB((double)i + d, 0.6D);
            t.addVertexWithUV((double)(x + 1) - dx(i), (double)y, (double)(z + 1) - dz(i), uvs[0] + du(i) * wu, uvs[2]);
            t.addVertexWithUV((double)(x + 1) - dx(i), (double)y + 0.05D, (double)(z + 1) - dz(i), uvs[0] + du(i) * wu, uvs[2] + wu * 0.05D);
            
            setB((double)(i + 1) - d, 0.6D);
            t.addVertexWithUV((double)(x + 1) - dx(i + 1), (double)y + 0.05D, (double)(z + 1) - dz(i + 1), uvs[0] + du2(i) * wu, uvs[2] + wu * 0.05D);
            t.addVertexWithUV((double)(x + 1) - dx(i + 1), (double)y, (double)(z + 1) - dz(i + 1), uvs[0] + du2(i) * wu, uvs[2]);            
        }
        ...
        for(int i = 0; i < 8; i++)
        {
            ...
            w = BASE_W;
            t.addVertexWithUV((double)x + dx(i), (double)(y + 1), (double)z + dz(i), uvt[0] + dx(i) * wu, uvt[3] - dz(i) * wv);
            t.addVertexWithUV((double)x + dx(i + 1), (double)(y + 1), (double)z + dz(i + 1), uvt[0] + dx(i + 1) * wu, uvt[3] - dz(i + 1) * wv);
        ...
        for(int i = 0; i < 8; i++)
        {
            ...
            w = BASE_W * h * 0.9D;
            t.addVertexWithUV((double)x + dx(i), (double)y, (double)z + dz(i), uvt[0] + dx(i) * wu, uvt[3] - dz(i) * wv);
            t.addVertexWithUV((double)x + dx(i + 1), (double)y, (double)z + dz(i + 1), uvt[0] + dx(i + 1) * wu, uvt[3] - dz(i + 1) * wv);
            ...
            w = 0.0D;
            t.addVertexWithUV((double)x + dx(i), (double)(y + 1) - h, (double)z + dz(i), uvt[0] + dx(i) * wu, uvt[3] - dz(i) * wv);
            t.addVertexWithUV((double)x + dx(i + 1), (double)(y + 1) - h, (double)z + dz(i + 1), uvt[0] + dx(i + 1) * wu, uvt[3] - dz(i + 1) * wv);
    ...
    private void setB(double i, double p, float r, float g, float b)
    {
    ...
    private void setB(double i, double p)
    {
