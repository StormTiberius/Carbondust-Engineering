...
public class ChunkProviderLaputa implements IChunkProvider
{
    /** RNG. */
    private Random rand;
    ...
    public ChunkProviderLaputa(World par1World, long par2, boolean par4)
    {
    ...
    {
        Arrays.fill(par3ArrayOfByte, (byte)0);
    }
