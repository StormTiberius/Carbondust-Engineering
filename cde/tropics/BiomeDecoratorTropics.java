...
public class BiomeDecoratorTropics extends BiomeDecorator
{
    ...
    protected void decorate()
    {
        ...
        {
            var3 = this.chunk_X + this.randomGenerator.nextInt(16) + 8;
            var4 = this.randomGenerator.nextInt(128) + 64;
        ...
        for (var2 = 0; doGen && var2 < this.waterlilyPerChunk; ++var2)
        {
            ...
            for (var7 = this.randomGenerator.nextInt(128) + 64; var7 > 0 && this.currentWorld.getBlockId(var3, var7 - 1, var4) == 0; --var7)
            {
                ;
            }
        ...
        for (var2 = 0; doGen && var2 < this.mushroomsPerChunk; ++var2)
        {
            ...
            if (this.randomGenerator.nextInt(8) == 0)
            {
                var3 = this.chunk_X + this.randomGenerator.nextInt(16) + 8;
                var4 = this.chunk_Z + this.randomGenerator.nextInt(16) + 8;
                var7 = this.randomGenerator.nextInt(128) + 64;
        ...
        {
            var2 = this.chunk_X + this.randomGenerator.nextInt(16) + 8;
            var3 = this.randomGenerator.nextInt(128) + 64;
            var4 = this.chunk_Z + this.randomGenerator.nextInt(16) + 8;
