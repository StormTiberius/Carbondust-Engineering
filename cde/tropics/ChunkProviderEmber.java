...
import cde.tropics.MapGenStronghold;
import cde.tropics.MapGenMineshaft;
import cde.tropics.MapGenRavine;
import cde.tropics.MapGenCaves;
import cde.tropics.DungeonManager;
...
public class ChunkProviderEmber implements IChunkProvider
{
    ...
    {
        Arrays.fill(par3ArrayOfByte, (byte)Block.stone.blockID);
    }
    ...
    public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
    {
        ...
        for (var12 = 0; doGen && var12 < 16; ++var12)
        {
            ...
            if (DungeonManager.generate(this.worldObj, this.rand, var13, var14, var15))
            {
                ;
            }
        }
